...
public class CouponContract implements Contract {
    ...
    public static final String COUPONGEN_CONTRACT_ID = "com.example.contract.CouponGenContract";
    ...
    private void verifyCouponGeneration(LedgerTransaction tx, List<PublicKey> signers) {
        ...
        requireThat(req -> {
            ...
            req.using("Output must be of the tyep CouponState ", outputState instanceof Commands.CouponGeneration);
